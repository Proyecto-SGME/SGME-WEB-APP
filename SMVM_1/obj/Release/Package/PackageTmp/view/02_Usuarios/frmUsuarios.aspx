                    ...
                    <tr>
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <asp:TextBox ID="txtRut" runat="server" Width="300px" class="form-control btn-group" placeholder="11.111.111-1" MaxLength="15"></asp:TextBox>
                        ...
                        <td>
                            <div class="form-group">
                                <label>Usuario</label>
                                <asp:TextBox ID="txtUs" runat="server" Width="300px" class="form-control" placeholder="Usuario ..." MaxLength="20"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group">
                                <label>Nombre</label>
                                <asp:TextBox ID="txtNombre" runat="server" Width="300px" class="form-control" placeholder="Nombre ..." MaxLength="50"></asp:TextBox>
                            </div>
                        </td>
                        <td></td>
                        <td>
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPw" runat="server" Width="300px" class="form-control" placeholder="Password ..." MaxLength="20" type="password"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                        <tr>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPaterno" runat="server" Width="300px" class="form-control" placeholder="Apellido Paterno ..." MaxLength="50"></asp:TextBox>
                            </div>
                            </td>
                            <td></td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtMaterno" runat="server" Width="300px" class="form-control" placeholder="Apellido Materno ..." MaxLength="50"></asp:TextBox>
                                </div>
                            </td>
                            <td></td>
                            <td>
