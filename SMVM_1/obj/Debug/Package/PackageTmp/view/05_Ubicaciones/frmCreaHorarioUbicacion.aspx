                ...
                <div class="box box-warning">
                    ...
                    <table id="t2" runat="server">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group time">
                                <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                <asp:TextBox ID="txtCierre" runat="server" Width="150px" class="form-control timepicker"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                            </td>
                    ...
                    <div id="ListarHorarios" runat="server" class="box-body no-padding">
                    </div>
                </div>
                <!--Fin-->
            </div>
